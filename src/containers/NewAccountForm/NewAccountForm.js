...
class NewAccountForm extends Component {
  ...
  submitHandler = (event) => {
    ...
    const accountData = {
      ...
      accountNumber: this.state.controls.accountNumber.value,
      currentBalance: this.state.controls.currentBalance.value,
    }
...
export default connect(mapStateToProps)(NewAccountForm);